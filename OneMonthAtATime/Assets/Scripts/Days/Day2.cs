...
public class Day2 : Day
{
    ...
    public Day2()
    {
        ...
        events.Add(new Event(
            new Option("Help them", 0, 5f, 0.02f, -0.1f, new string[] { "0 5 00 00 00 Well, glad they figured it out, and I feel good about helping. Unfortunately, I also lost all the extra time I had. Guess I’m eating lunch in a hurry again or I’ll be late for the meeting for my group project." }),
            new Option("Tell them to ask the prof", 0f, 0f, 0f, 0.1f, new string[] { "0 3 00 00 00 I don’t want to be rude but I’m way too tired, the prof is literally right there to help and will probably give better advice than I could. I just really need some time to myself to collect my thoughts." }),
            new Option("Say you're busy", 0, 5f, 0.02f, -0.1f, new string[] { "0 4 00 00 00 Funny how that works, by pretending to work on something for half an hour I was actually pretty productive. I do feel kinda bad though… just a little." })));
