     ...
     public Day1()
     {
          ...
          events.Add(new Event(
                 new Option("Grab a shift at the restaurant ", 3, new string[] {
                     ...
                     "1 3 12 00 00 3 Vic! Good to see you come in. We are already getting pretty swamped and two of the new morons we hired have already called in sick. Looks like your generation doesn’t know the concept of a good work ethic! Get your uniform on and serve that party that just came in.",
                     "0 2 12 00 00 3 Roger that. ",
                     "0 1 00 00 00 3 (If I really put a lot of effort in, I could probably make a decent amount of tips. Nobody is willing to shell out money to just anyone.)"}),
