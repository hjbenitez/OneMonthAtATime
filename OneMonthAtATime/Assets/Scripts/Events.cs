...
public class Events
{
    ...
    public Events()
    {
        ...
        events.Add(new Event(
            ...
            new string[] { "90…Ok does everyone understand the exercise? Great. I’ll be in class for another half hour if anyone needs help.", "05*Yawns*", "02Glad the exercise is something I already know, I can get it done in 5 minutes and leave class early. It would be nice to get a longer lunch break for once-",
        ...
        events.Add(new Event(
            ...
            "10Oh is that all? Well let me tell you two things. First off, Victoria here is not the moron in the situation, you are. Secondly, do you really expect us to refund a steak when you have basically only left crumbs left? You are just trying to get a free meal and that isn’t happening.", "90How appalling. You can’t treat a customer like that! Haven’t you heard that the customer is always right? Give me my money back NOW or else I am walking out and never coming back.",
