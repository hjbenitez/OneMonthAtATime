...
public class Events
{
    ...
    public Events()
    {
        ...
        events.Add(new Event(
            new Option("Help them", 0, 5f, 0.02f, -0.1f, new string[1] { "05Well, glad they figured it out, and I feel good about helping. Unfortunately, I also lost all the extra time I had. Guess I知 eating lunch in a hurry again or I値l be late for the meeting for my group project." }),
            new Option("Sorry, I don't have tme, ask the prof", 0f, 0f, 0f, 0.1f, new string[1] {"03I don稚 want to be rude but I知 way too tired, the prof is literally right there to help and will probably give better advice than I could. I just really need some time to myself to collect my thoughts."}), 
